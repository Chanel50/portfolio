  ...
  <section className="mb-32 text-gray-800">
    <div className="flex flex-wrap">
      <div className="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
        ...
        <p className="text-gray-500 mb-2">Cité les grands vents Dely Ibrahim, Algérie</p>
        <p className="text-gray-500 mb-2">+ 213991465776</p>
        <p className="text-gray-500 mb-2">chanel50@gmail.com</p>
      </div>
